...
Generated: 2026-08-11T03:10:44.961Z
...
- Overall substantive words: min 30, average 535, max 897
...
| guide | 12 | 336 | 371 | 451 |
| reference | 8 | 287 | 356 | 414 |
| tool | 50 | 565 | 693 | 897 |
...
- 50 pages: “use it when you can describe the current state and need a defensible next check”
- 50 pages: “it is not a shortcut around inspection preserve the starting state change one variable and verify the result under the same conditions”
- 50 pages: “use a stable tuned instrument unless the page specifically investigates tuning”
- 50 pages: “name the physical reference unit and test condition beside every important number”
- 50 pages: “keep the original measurements so any reversible change can be returned to baseline”
- 50 pages: “a placeholder demonstrates format only it is never a recommendation for a particular guitar”
- 50 pages: “save or print the result ticket with the entered conditions so another person can reproduce the decision”
- 50 pages: “the page keeps calculation and diagnostic claims deliberately bounded”
- 50 pages: “display rounding improves readability while the underlying logic uses entered values descriptive branches report relative tendencies and the evidence needed to confirm them”
- 50 pages: “substitute real measurements and repeat the final test before accepting the next action”
- 50 pages: “instrument design service history measurement error and player technique can outweigh a calculator or checklist”
- 50 pages: “where manufacturer instructions exist for the exact hardware use those instructions and record the revision consulted”
...
| `/guides/diagnose-guitar-hum-safely.html` | guide | site | 352 | 8 | 4/4 | 31.8% | 0.0% | 0 | 2/2 | yes | — | **Sufficient** |
...
| `/` | basic | site | 604 | 11 | 0/scope | 0.0% | 0.0% | 0 | 0/34 | yes | — | **Sufficient** |
...
| `/tools/before-after-setup-card.html` | tool | Shop documents | 619 | 10 | 9/9 | 40.5% | 26.2% | 0 | 9/3 | yes | — | **Sufficient** |
...
| `/tools/ground-hum-diagnostic.html` | tool | Electronics & wiring | 798 | 10 | 9/9 | 36.0% | 10.0% | 0 | 4/3 | yes | — | **Sufficient** |
...
| `/tools/knob-shaft-compatibility.html` | tool | Control hardware fit & layout | 812 | 10 | 9/9 | 38.3% | 10.6% | 0 | 5/3 | yes | — | **Sufficient** |
...
| `/tools/pickup-phase-troubleshooter.html` | tool | Electronics & wiring | 686 | 10 | 9/9 | 42.9% | 16.7% | 0 | 5/3 | yes | — | **Sufficient** |
...
| `/tools/potentiometer-value-selector.html` | tool | Electronics & wiring | 662 | 10 | 9/9 | 45.0% | 15.0% | 0 | 5/3 | yes | — | **Sufficient** |
